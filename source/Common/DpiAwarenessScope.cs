...
namespace PlayniteAchievements.Common
{
    ...
    /// Windows from bitmap-stretching (and thereby blurring) the window on a monitor whose effective
    /// DPI differs from the process's system DPI -- for example after Playnite is opened on a
    /// 1080p/1440p monitor and moved to a scaled 4K one.
    ///
    ...
    internal static class DpiAwarenessScope
    {
        ...
        /// so callers can always wrap HWND creation in <c>using (DpiAwarenessScope.PerMonitorV2())</c>
